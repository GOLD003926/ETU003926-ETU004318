...
--view
CREATE OR REPLACE VIEW v_emprunt_objet_membre AS 
SELECT 
    eo.id_emprunt,
    o.nom_objet,
    o.id_objet,
    ...
    eo.date_emprunt,
    eo.date_retour
FROM final_emprunt eo
JOIN final_objet o ON eo.id_objet = o.id_objet
JOIN final_membre m ON eo.id_membre = m.id_membre;